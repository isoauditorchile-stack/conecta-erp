...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-buttons">
                <a href="register.php" class="btn btn-primary" style="background: white; color: #667eea;">Comenzar Gratis</a>
    ...
    <section class="pricing" id="pricing">
        <div class="container">
            ...
            <p class="section-subtitle">Elija el plan que mejor se adapte a sus necesidades</p>
    ...
    <section class="cta">
        <div class="container">
            ...
            <a href="register.php" class="btn btn-primary" style="background: white; color: #667eea;">Prueba Gratuita 30 Días</a>
        </div>
    </section>
