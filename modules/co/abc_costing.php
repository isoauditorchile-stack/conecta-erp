...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM co_abc_costing WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Costos ABC - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./abc_costing.php" class="menu-link active"><i class="fa-project-diagram"></i> Costos ABC</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-project-diagram"></i> Costos ABC</h1>
