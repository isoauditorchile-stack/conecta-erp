...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM co_cost_centers WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./cost_centers.php" class="menu-link active"><i class="fa-sitemap"></i> Centros de Costo</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-sitemap"></i> Centros de Costo</h1>
