...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM co_investment_control WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Control de Inversiones - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="../CO/index.php" class="menu-link"><i class="fas fa-arrow-left"></i> Volver a Controlling</a></li>
            <li><a href="./investments.php" class="menu-link active"><i class="fa-money-bill-wave"></i> Control de Inversiones</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-money-bill-wave"></i> Control de Inversiones</h1>
