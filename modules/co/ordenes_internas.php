...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM co_internal_orders WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Órdenes Internas - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./internal_orders.php" class="menu-link active"><i class="fa-clipboard-list"></i> Órdenes Internas</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-clipboard-list"></i> Órdenes Internas</h1>
