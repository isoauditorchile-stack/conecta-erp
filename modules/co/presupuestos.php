...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM co_budgets WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./budgets.php" class="menu-link active"><i class="fa-calculator"></i> Presupuestos</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-calculator"></i> Presupuestos</h1>
