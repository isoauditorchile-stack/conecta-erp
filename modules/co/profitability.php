...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM co_profitability_analysis WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./profitability.php" class="menu-link active"><i class="fa-chart-line"></i> Análisis de Rentabilidad</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-chart-line"></i> Análisis de Rentabilidad</h1>
