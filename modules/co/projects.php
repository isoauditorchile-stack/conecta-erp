...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM co_project_analysis WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Análisis de Proyectos - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./projects.php" class="menu-link active"><i class="fa-tasks"></i> Análisis de Proyectos</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-tasks"></i> Análisis de Proyectos</h1>
