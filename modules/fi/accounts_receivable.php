...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_accounts_receivable WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./accounts_receivable.php" class="menu-link active"><i class="fa-hand-holding-usd"></i> Cuentas por Cobrar</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-hand-holding-usd"></i> Cuentas por Cobrar</h1>
