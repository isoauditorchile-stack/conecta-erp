...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_bank_reconciliation WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Bancos y Conciliaciones - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./banks.php" class="menu-link active"><i class="fa-landmark"></i> Bancos y Conciliaciones</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-landmark"></i> Bancos y Conciliaciones</h1>
