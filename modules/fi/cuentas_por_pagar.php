...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_accounts_payable WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./accounts_payable.php" class="menu-link active"><i class="fa-file-invoice-dollar"></i> Cuentas por Pagar</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-file-invoice-dollar"></i> Cuentas por Pagar</h1>
