...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_fixed_assets WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./fixed_assets.php" class="menu-link active"><i class="fa-building"></i> Activos Fijos</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-building"></i> Activos Fijos</h1>
