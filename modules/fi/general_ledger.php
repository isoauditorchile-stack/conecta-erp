...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_general_ledger WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./general_ledger.php" class="menu-link active"><i class="fa-book"></i> Contabilidad General</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-book"></i> Contabilidad General</h1>
