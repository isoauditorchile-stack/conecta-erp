...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_journal_entries WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Asientos Contables - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./journal_entries.php" class="menu-link active"><i class="fa-pen-alt"></i> Asientos Contables</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-pen-alt"></i> Asientos Contables</h1>
