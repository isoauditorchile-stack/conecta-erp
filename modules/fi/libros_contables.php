...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_accounting_books WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Libros Contables - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./accounting_books.php" class="menu-link active"><i class="fa-book-open"></i> Libros Contables</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-book-open"></i> Libros Contables</h1>
