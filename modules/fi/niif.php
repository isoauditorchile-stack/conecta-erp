...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_ifrs_reports WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>IFRS Reporting - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./ifrs.php" class="menu-link active"><i class="fa-chart-bar"></i> IFRS Reporting</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-chart-bar"></i> IFRS Reporting</h1>
