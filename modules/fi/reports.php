...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM fi_financial_reports WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Reportes Financieros - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./reports.php" class="menu-link active"><i class="fa-file-pdf"></i> Reportes Financieros</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-file-pdf"></i> Reportes Financieros</h1>
