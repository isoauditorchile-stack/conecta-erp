...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM hcm_attendance WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Asistencia - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./attendance.php" class="menu-link active"><i class="fa-clock"></i> Asistencia</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-clock"></i> Asistencia</h1>
