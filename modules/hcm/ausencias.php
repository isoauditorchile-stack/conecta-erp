...
<head>
    ...
    <title>Vacaciones - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./leaves.php" class="menu-link active"><i class="fa-plane"></i> Vacaciones</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-plane"></i> Vacaciones</h1>
