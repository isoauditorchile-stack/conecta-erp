...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM hcm_training WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Capacitación - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./training.php" class="menu-link active"><i class="fa-graduation-cap"></i> Capacitación</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-graduation-cap"></i> Capacitación</h1>
