...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM hcm_org_development WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Desarrollo Org. - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="../HCM/index.php" class="menu-link"><i class="fas fa-arrow-left"></i> Volver a Capital Humano</a></li>
            <li><a href="./org_development.php" class="menu-link active"><i class="fa-sitemap"></i> Desarrollo Org.</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-sitemap"></i> Desarrollo Org.</h1>
