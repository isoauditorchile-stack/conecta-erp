...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM hcm_performance_reviews WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Evaluación - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./performance.php" class="menu-link active"><i class="fa-star"></i> Evaluación</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-star"></i> Evaluación</h1>
