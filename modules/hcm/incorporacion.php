...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM hcm_onboarding WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Onboarding - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./onboarding.php" class="menu-link active"><i class="fa-handshake"></i> Onboarding</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-handshake"></i> Onboarding</h1>
