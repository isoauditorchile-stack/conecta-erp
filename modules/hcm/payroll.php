...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM hcm_payroll WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Nómina - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./payroll.php" class="menu-link active"><i class="fa-money-check-alt"></i> Nómina</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-money-check-alt"></i> Nómina</h1>
