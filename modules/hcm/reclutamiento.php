...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM hcm_recruitment WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Reclutamiento - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./recruitment.php" class="menu-link active"><i class="fa-user-plus"></i> Reclutamiento</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-user-plus"></i> Reclutamiento</h1>
