...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM mm_warehouses WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Almacenes - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./warehouses.php" class="menu-link active"><i class="fa-warehouse"></i> Almacenes</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-warehouse"></i> Almacenes</h1>
