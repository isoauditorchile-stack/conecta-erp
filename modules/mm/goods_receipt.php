...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM mm_goods_receipt WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Recepción - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./goods_receipt.php" class="menu-link active"><i class="fa-dolly"></i> Recepción</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-dolly"></i> Recepción</h1>
