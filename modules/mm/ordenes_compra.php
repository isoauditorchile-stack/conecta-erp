...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM mm_purchase_orders WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Órdenes de Compra - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="../MM/index.php" class="menu-link"><i class="fas fa-arrow-left"></i> Volver a Materiales</a></li>
            <li><a href="./purchase_orders.php" class="menu-link active"><i class="fa-shopping-cart"></i> Órdenes de Compra</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-shopping-cart"></i> Órdenes de Compra</h1>
