...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM mm_suppliers WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./suppliers.php" class="menu-link active"><i class="fa-truck-loading"></i> Proveedores</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-truck-loading"></i> Proveedores</h1>
