...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM pp_capacity_planning WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Capacidades - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./capacity.php" class="menu-link active"><i class="fa-chart-pie"></i> Capacidades</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-chart-pie"></i> Capacidades</h1>
