...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./work_centers.php" class="menu-link active"><i class="fa-industry"></i> Centros de Trabajo</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-industry"></i> Centros de Trabajo</h1>
