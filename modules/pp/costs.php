...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM pp_production_costs WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Costos - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./costs.php" class="menu-link active"><i class="fa-dollar-sign"></i> Costos</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-dollar-sign"></i> Costos</h1>
