...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM pp_formulas WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Fórmulas - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./formulas.php" class="menu-link active"><i class="fa-flask"></i> Fórmulas</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-flask"></i> Fórmulas</h1>
