...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM pp_preventive_maintenance WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./maintenance.php" class="menu-link active"><i class="fa-tools"></i> Mantenimiento</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-tools"></i> Mantenimiento</h1>
