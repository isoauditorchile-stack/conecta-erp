...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM pp_mrp_ii WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>MRP II - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./mrp_ii.php" class="menu-link active"><i class="fa-project-diagram"></i> MRP II</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-project-diagram"></i> MRP II</h1>
