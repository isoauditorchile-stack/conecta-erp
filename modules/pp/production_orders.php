...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM pp_production_orders WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Órdenes de Producción - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="../PP/index.php" class="menu-link"><i class="fas fa-arrow-left"></i> Volver a Producción</a></li>
            <li><a href="./production_orders.php" class="menu-link active"><i class="fa-industry"></i> Órdenes de Producción</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-industry"></i> Órdenes de Producción</h1>
