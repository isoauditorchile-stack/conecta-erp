...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM pp_quality_control WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./quality.php" class="menu-link active"><i class="fa-check-double"></i> Control de Calidad</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-check-double"></i> Control de Calidad</h1>
