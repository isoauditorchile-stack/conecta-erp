...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM pp_routing WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Rutinas - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./routing.php" class="menu-link active"><i class="fa-route"></i> Rutinas</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-route"></i> Rutinas</h1>
