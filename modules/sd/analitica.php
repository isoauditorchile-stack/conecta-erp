...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM sd_sales_analytics WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./analytics.php" class="menu-link active"><i class="fa-chart-area"></i> Análisis de Ventas</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-chart-area"></i> Análisis de Ventas</h1>
