...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM sd_ecommerce_orders WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>E-commerce - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./ecommerce.php" class="menu-link active"><i class="fa-store"></i> E-commerce</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-store"></i> E-commerce</h1>
