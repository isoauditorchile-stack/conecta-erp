...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM sd_commissions WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Comisiones - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./commissions.php" class="menu-link active"><i class="fa-percentage"></i> Comisiones</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-percentage"></i> Comisiones</h1>
