...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM sd_quotations WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./quotations.php" class="menu-link active"><i class="fa-file-alt"></i> Cotizaciones</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-file-alt"></i> Cotizaciones</h1>
