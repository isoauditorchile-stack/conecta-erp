...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM sd_customers WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./customers.php" class="menu-link active"><i class="fa-users"></i> Clientes</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-users"></i> Clientes</h1>
