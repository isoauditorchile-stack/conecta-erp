...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM sd_sales_orders WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./sales_orders.php" class="menu-link active"><i class="fa-shopping-bag"></i> Pedidos de Venta</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-shopping-bag"></i> Pedidos de Venta</h1>
