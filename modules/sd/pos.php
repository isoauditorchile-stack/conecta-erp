...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM sd_pos_transactions WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="./pos.php" class="menu-link active"><i class="fa-cash-register"></i> Punto de Venta</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-cash-register"></i> Punto de Venta</h1>
