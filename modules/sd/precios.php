...
// Obtener datos
$records = $db->fetchAll("SELECT * FROM sd_dynamic_pricing WHERE user_id = ? ORDER BY id DESC LIMIT 100", [$user['id']]);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Precios Dinámicos - CONECTA ERP</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="../SD/index.php" class="menu-link"><i class="fas fa-arrow-left"></i> Volver a Ventas & Distribución</a></li>
            <li><a href="./pricing.php" class="menu-link active"><i class="fa-tags"></i> Precios Dinámicos</a></li>
        </ul>
    </aside>
    <main class="main-content">
        <div class="topbar">
            <h1 class="page-title"><i class="fa-tags"></i> Precios Dinámicos</h1>
