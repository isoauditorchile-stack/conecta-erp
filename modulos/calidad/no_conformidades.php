...
// TODO: Implementar lógica CRUD para tabla: no_conformidades
...
<head>
    ...
    <title>No Conformidades | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-exclamation-triangle"></i> No Conformidades</h1>
