...
<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><title>Reportes Gestión - CONECTA ERP</title>
...
<body>
<div class="sidebar"><h3><i class="fas fa-file-alt"></i> Reportes</h3><a href="../../user/dashboard.php" class="btn btn-light btn-sm w-100 mt-3"><i class="fas fa-arrow-left"></i> Dashboard</a></div>
