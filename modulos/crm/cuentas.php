...
<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><title>Cuentas - CONECTA ERP</title>
...
<body>
<div class="sidebar"><h3><i class="fas fa-building"></i> Cuentas</h3><a href="../../user/dashboard.php" class="btn btn-light btn-sm w-100 mt-3"><i class="fas fa-arrow-left"></i> Dashboard</a></div>
<div class="content">
