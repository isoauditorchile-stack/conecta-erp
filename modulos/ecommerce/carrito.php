...
// TODO: Implementar lógica CRUD para tabla: carrito
...
<head>
    ...
    <title>Carrito Compras | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-cart-plus"></i> Carrito Compras</h1>
