...
// TODO: Implementar lógica CRUD para tabla: cupones
...
<head>
    ...
    <title>Cupones Descuento | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-ticket-alt"></i> Cupones Descuento</h1>
