...
// TODO: Implementar lógica CRUD para tabla: programas_lealtad
...
<head>
    ...
    <title>Programas Lealtad | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-award"></i> Programas Lealtad</h1>
