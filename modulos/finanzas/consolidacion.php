...
<head>
    <meta charset="UTF-8">
    <title>Consolidación - CONECTA ERP</title>
...
<body>
    <div class="sidebar">
        <h3><i class="fas fa-sitemap"></i> Consolidación</h3>
        <a href="../../user/dashboard.php" class="btn btn-light btn-sm w-100 mt-3"><i class="fas fa-arrow-left"></i> Dashboard</a>
    </div>
    <div class="content">
        <h2><i class="fas fa-sitemap text-primary"></i> Consolidación Financiera</h2>
        <div class="alert alert-info">
            <i class="fas fa-info-circle"></i> Consolidación multi-empresa para holdings y grupos empresariales
        </div>
    </div>
</body>
</html>
