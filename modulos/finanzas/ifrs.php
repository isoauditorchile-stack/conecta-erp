...
<body>
    <div class="sidebar">
        <h3><i class="fas fa-globe"></i> IFRS</h3>
        <a href="../../user/dashboard.php" class="btn btn-light btn-sm w-100 mt-3"><i class="fas fa-arrow-left"></i> Dashboard</a>
    </div>
    <div class="content">
        <h2><i class="fas fa-globe text-primary"></i> Normas IFRS</h2>
        <div class="alert alert-info">
            <i class="fas fa-info-circle"></i> Módulo de Normas Internacionales de Información Financiera (IFRS)
        </div>
    </div>
</body>
</html>
