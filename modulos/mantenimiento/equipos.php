<?php
/**
 * Equipos Maquinaria - CONECTA ERP
...
// TODO: Implementar lógica CRUD para tabla: equipos
...
<head>
    ...
    <title>Equipos Maquinaria | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-cogs"></i> Equipos Maquinaria</h1>
