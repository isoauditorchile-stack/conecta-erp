...
// TODO: Implementar lógica CRUD para tabla: ordenes_trabajo
...
<head>
    ...
    <title>Órdenes Trabajo | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-clipboard-list"></i> Órdenes Trabajo</h1>
