<?php
/**
 * Mantenimiento Preventivo - CONECTA ERP
...
// TODO: Implementar lógica CRUD para tabla: mantenimiento_preventivo
...
<head>
    ...
    <title>Mantenimiento Preventivo | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-calendar-check"></i> Mantenimiento Preventivo</h1>
