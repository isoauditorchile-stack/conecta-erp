<?php
/**
 * BOM (Lista Materiales) - CONECTA ERP
...
// TODO: Implementar lógica CRUD para tabla: bom
...
<head>
    ...
    <title>BOM (Lista Materiales) | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-list"></i> BOM (Lista Materiales)</h1>
