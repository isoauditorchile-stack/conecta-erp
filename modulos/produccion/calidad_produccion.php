<?php
/**
 * Calidad Producción - CONECTA ERP
...
// TODO: Implementar lógica CRUD para tabla: calidad_produccion
...
<head>
    ...
    <title>Calidad Producción | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-award"></i> Calidad Producción</h1>
