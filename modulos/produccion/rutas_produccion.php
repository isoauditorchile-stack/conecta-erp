<?php
/**
 * Rutas de Producción - CONECTA ERP
...
// TODO: Implementar lógica CRUD para tabla: rutas_produccion
...
<head>
    ...
    <title>Rutas de Producción | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-route"></i> Rutas de Producción</h1>
