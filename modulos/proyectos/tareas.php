...
// TODO: Implementar lógica CRUD para tabla: tareas_proyectos
...
<head>
    ...
    <title>Tareas Proyectos | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-tasks"></i> Tareas Proyectos</h1>
