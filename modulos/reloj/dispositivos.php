<?php
/**
 * Dispositivos Biométricos - CONECTA ERP
...
// TODO: Implementar lógica CRUD para tabla: dispositivos_biometricos
...
<head>
    ...
    <title>Dispositivos Biométricos | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-mobile-alt"></i> Dispositivos Biométricos</h1>
