...
// TODO: Implementar lógica CRUD para tabla: documentos_rrhh
...
<head>
    ...
    <title>Documentos RRHH | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-folder"></i> Documentos RRHH</h1>
