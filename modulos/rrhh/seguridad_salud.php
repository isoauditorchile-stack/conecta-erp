...
// TODO: Implementar lógica CRUD para tabla: seguridad_salud
...
<head>
    ...
    <title>Seguridad y Salud | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-shield-alt"></i> Seguridad y Salud</h1>
