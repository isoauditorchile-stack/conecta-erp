<?php
/**
 * Contratos Proveedores - CONECTA ERP
...
// TODO: Implementar lógica CRUD para tabla: contratos_proveedores
...
<head>
    ...
    <title>Contratos Proveedores | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-file-contract"></i> Contratos Proveedores</h1>
