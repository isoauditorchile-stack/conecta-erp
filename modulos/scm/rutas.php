<?php
/**
 * Rutas Distribución - CONECTA ERP
...
// TODO: Implementar lógica CRUD para tabla: rutas_distribucion
...
<head>
    ...
    <title>Rutas Distribución | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-route"></i> Rutas Distribución</h1>
