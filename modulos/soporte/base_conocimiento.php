...
// TODO: Implementar lógica CRUD para tabla: base_conocimiento
...
<head>
    ...
    <title>Base Conocimiento | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-book"></i> Base Conocimiento</h1>
