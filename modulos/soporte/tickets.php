...
// TODO: Implementar lógica CRUD para tabla: tickets_soporte
...
<head>
    ...
    <title>Tickets Soporte | CONECTA ERP</title>
    ...
    <div class="container-fluid py-4">
        <div class="gradient-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-ticket-alt"></i> Tickets Soporte</h1>
