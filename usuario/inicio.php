...
$id_usuario = Sesion::obtener('id_usuario', 0);
$id_empresa = Sesion::obtener('id_empresa', 0);
$es_admin = Sesion::es_administrador();

// VERIFICAR SI ES SUPER ADMIN (auditorexchile@gmail.com) - ÚNICO CON ACCESO TOTAL
...
<head>
    ...
    <style>
        ...
        .acceso-restringido::after {
            content: "🔒 Requiere Upgrade";
            position: absolute;
            top: 50%;
            left: 50%;
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 sidebar">
                ...
                <a href="biblioteca/normas.php"><i class="fas fa-certificate"></i> Normas ISO</a>
                <a href="biblioteca/formatos.php"><i class="fas fa-file-alt"></i> Formatos</a>
                <a href="contenidos.php"><i class="fas fa-book"></i> Recursos</a>
                <hr class="text-white">
                <div class="px-3 text-muted small mb-2">MIS DOCUMENTOS</div>
                <a href="documentos/listar.php"><i class="fas fa-folder-open"></i> Ver Documentos</a>
                <a href="documentos/subir.php"><i class="fas fa-upload"></i> Subir Documento</a>
                <hr class="text-white">
                <div class="px-3 text-muted small mb-2">FORMULARIOS</div>
                <a href="formulario_online.php"><i class="fas fa-edit"></i> Formularios Online</a>
                <hr class="text-white">
                <div class="px-3 text-muted small mb-2">MI CUENTA</div>
                <a href="suscripcion/mi_plan.php"><i class="fas fa-credit-card"></i> Mi Suscripción</a>
            ...
            <div class="col-md-10 p-4">
                ...
                <!-- ============================================== -->
                <!-- MÓDULOS DE NORMAS ISO - SOLO SUPER ADMIN TIENE ACCESO TOTAL -->
                <!-- ============================================== -->
                <?php if ($es_super_admin): ?>
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="alert alert-success">
                            ...
                            <p class="mb-0">Como <strong>Super Admin</strong>, tienes acceso completo a todos los 30 módulos de normas ISO con documentación completa, controles, políticas, procedimientos y formatos.</p>
                        </div>
                    </div>
                </div>
                ...
                <?php else: ?>
                <!-- VISTA PARA USUARIOS SIN ACCESO TOTAL -->
                <div class="row mb-4">
                    <div class="col-12">
                        <h3><i class="fas fa-certificate text-primary"></i> Módulos de Normas ISO</h3>
                        <div class="alert alert-warning">
                            <h5><i class="fas fa-lock"></i> Acceso Limitado</h5>
                            <p>Actualmente tienes acceso limitado. Para acceder a todos los 30 módulos de normas ISO con documentación completa, controles, políticas, procedimientos y formatos, actualiza tu plan.</p>
                            <a href="suscripcion/mi_plan.php" class="btn btn-warning"><i class="fas fa-arrow-up"></i> Actualizar Plan</a>
                        </div>
                    </div>
                </div>

                <!-- Mostrar solo versión demo/limitada de los módulos -->
                <div class="row mb-3">
                    <div class="col-12">
                        <h5 class="text-muted"><i class="fas fa-star"></i> Vista Previa de Módulos Disponibles</h5>
                        <p class="text-muted small">Actualiza tu plan para acceso completo</p>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="card h-100 border-secondary acceso-restringido">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-secondary btn-sm w-100" disabled>Requiere Upgrade</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
